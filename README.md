...
Spec workflow for AI-assisted development. 12 prompt templates that turn a one-line intent + your project context into a filled, structured spec your coding agent can implement from.
