...
${CLAUDE_PLUGIN_ROOT}/specs/ready.md
```

If `${CLAUDE_PLUGIN_ROOT}` is unset, search upward from this file's location. Both generators use `teacher.md` in **coach posture** — same staff engineer, hiring-bar stance.
