...
If `${CLAUDE_PLUGIN_ROOT}` is unset, search upward from this file's location. Follow the system-design partition seam exactly: this guide owns architecture, not reusable DSA curriculum.
