...
```
${CLAUDE_PLUGIN_ROOT}/specs/generate-demo-guide.md
```

If `${CLAUDE_PLUGIN_ROOT}` is unset (running from a dev clone), fall back to searching for `specs/generate-demo-guide.md` upward from this file's location.
