...
If `${CLAUDE_PLUGIN_ROOT}` is unset (running from a dev clone), fall back to searching for `specs/refactor.md` and `specs/audit-refactor.md` upward from this file's location.
