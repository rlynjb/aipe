...
```
${CODEX_PLUGIN_ROOT}/specs/plan.md
```

If `${CODEX_PLUGIN_ROOT}` is unset (running from a dev clone), fall back to searching for `specs/plan.md` upward from this file's location.
