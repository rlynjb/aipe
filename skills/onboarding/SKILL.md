...
```
${CODEX_PLUGIN_ROOT}/specs/onboarding.md
```

If `${CODEX_PLUGIN_ROOT}` is unset (running from a dev clone), fall back to searching for `specs/onboarding.md` upward from this file's location.
