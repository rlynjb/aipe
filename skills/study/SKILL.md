...
${CODEX_PLUGIN_ROOT}/specs/study-software-design.md       (code-level design audit topic)
${CODEX_PLUGIN_ROOT}/specs/study-security.md              (trust-axis audit topic)
${CODEX_PLUGIN_ROOT}/specs/study-testing.md               (deterministic-correctness audit topic)
