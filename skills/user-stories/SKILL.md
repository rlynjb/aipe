...
```
${CODEX_PLUGIN_ROOT}/specs/user-stories.md
```

If `${CODEX_PLUGIN_ROOT}` is unset (running from a dev clone), fall back to searching for `specs/user-stories.md` upward from this file's location.
