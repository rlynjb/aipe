...
```
${CODEX_PLUGIN_ROOT}/specs/migration.md
```

If `${CODEX_PLUGIN_ROOT}` is unset (running from a dev clone), fall back to searching for `specs/migration.md` upward from this file's location.
