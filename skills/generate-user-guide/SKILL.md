...
```
${CODEX_PLUGIN_ROOT}/specs/generate-user-guide.md
```

If `${CODEX_PLUGIN_ROOT}` is unset (running from a dev clone), fall back to searching for `specs/generate-user-guide.md` upward from this file's location.
