...
```
${CODEX_PLUGIN_ROOT}/specs/performance.md
```

If `${CODEX_PLUGIN_ROOT}` is unset (running from a dev clone), fall back to searching for `specs/performance.md` upward from this file's location.
