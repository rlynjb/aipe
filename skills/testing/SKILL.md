...
```
${CODEX_PLUGIN_ROOT}/specs/testing.md
```

If `${CODEX_PLUGIN_ROOT}` is unset (running from a dev clone), fall back to searching for `specs/testing.md` upward from this file's location.
