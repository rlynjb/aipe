...
```
${CODEX_PLUGIN_ROOT}/specs/audit-frontend-a11y.md
```

If `${CODEX_PLUGIN_ROOT}` is unset (running from a dev clone), fall back to searching for `specs/audit-frontend-a11y.md` upward from this file's location.
