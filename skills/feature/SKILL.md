...
```
${CODEX_PLUGIN_ROOT}/specs/feature.md
```

If `${CODEX_PLUGIN_ROOT}` is unset (running from a dev clone), fall back to searching for `specs/feature.md` upward from this file's location.
