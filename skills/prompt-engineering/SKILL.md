...
```
${CODEX_PLUGIN_ROOT}/specs/prompt-engineering.md
```

If `${CODEX_PLUGIN_ROOT}` is unset (running from a dev clone), fall back to searching for `specs/prompt-engineering.md` upward from this file's location.
