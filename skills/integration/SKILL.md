...
```
${CODEX_PLUGIN_ROOT}/specs/integration.md
```

If `${CODEX_PLUGIN_ROOT}` is unset (running from a dev clone), fall back to searching for `specs/integration.md` upward from this file's location.
