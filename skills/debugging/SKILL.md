...
```
${CODEX_PLUGIN_ROOT}/specs/debugging.md
```

If `${CODEX_PLUGIN_ROOT}` is unset (running from a dev clone), fall back to searching for `specs/debugging.md` upward from this file's location.
