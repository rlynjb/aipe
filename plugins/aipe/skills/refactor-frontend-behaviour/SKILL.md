---
name: refactor-frontend-behaviour
...
If `${CODEX_PLUGIN_ROOT}` is unset (running from a dev clone), fall back to searching for `specs/refactor.md` and `specs/refactor-frontend-behaviour.md` upward from this file's location.
